...
#    Updated: 2024/12/18 07:15:06 by janaebyrne       ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
Utils/utils.c Utils/utils1.c Utils/utils2.c Utils/utils3.c Execution/Exec/Exec.c Execution/Exec/ft_external_commands.c \
Utils/ft_split.c Execution/Builtins/ft_exit.c Execution/Exec/ft_execute_pipeline.c Execution/Builtins/ft_update_env.c \
Execution/Exec/Signals/ft_signals.c Parsing/ft_parse_pipeline.c Parsing/ft_parse_redirections.c free.c \
